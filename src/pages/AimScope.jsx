...
const AimScope = () => {
  ...
  return (
    <>
      ...
      <div className="aim-scope-page">
        ...
        <div data-aos="fade-up" className="aim-scope-content">
    ...
    fontFamily: 'system-ui, -apple-system, "Segoe UI"',}}>
        ...
        <div data-aos="fade-left" className="aim-scope-content">
    ...
    fontSize: '17.6px', // Use camelCase
    fontFamily: 'system-ui, -apple-system, "Segoe UI"',}} data-aos="fade-up">
 ...
 We encourage the publication of new research that explores innovative ideas, methodologies, and technologies that contribute to the growth of science and technology.
        ...
        <section className="aim-scope-section">
        <div  data-aos="fade-right" className="aim-scope-content">
          <h2 className="section-title" style={{ color: '#0072b1' }}>
  ...
  <ol className="scope-list">
    <li>
      ...
      <div  data-aos="fade-up" className="aim-scope-content">
        ...
        <b className='center' style={{fontSize:"20px"}}>Engineering and Technology</b>
        </div>
      </center>
  ...
  <ol className="scope-list">
    <li>
      ...
      <div  data-aos="fade-up" className="aim-scope-content">
        ...
        <b className='center'  style={{fontSize:"20px"}}>Sciences</b>
        </div>
      </center>
      <ul className="nested-list left1">
      <div  data-aos="fade-left" className="aim-scope-content">
  ...
  <ol className="scope-list">
    <li>
      ...
      <div  data-aos="fade-up" className="aim-scope-content">
        ...
        <b className='center'  style={{fontSize:"20px"}}>Social Sciences and Humanities</b>
        </div>
      </center>
      <ul className="nested-list left1">
      <div  data-aos="fade-left" className="aim-scope-content">
  ...
  <ol className="scope-list">
    <li>
      ...
      <div  data-aos="fade-up" className="aim-scope-content">
        ...
        <b className='center'  style={{fontSize:"20px"}}>Business and Economics</b>
        </div>
      </center>
      <ul className="nested-list left1">
      <div  data-aos="fade-left" className="aim-scope-content">
              ...
              <ol className="scope-list">
                <li>
                  ...
                  <div  data-aos="fade-up" className="aim-scope-content">
                    ...
                    <b className='center'  style={{fontSize:"20px"}}>Medical and Health Sciences</b>
                    </div>
                  </center>
